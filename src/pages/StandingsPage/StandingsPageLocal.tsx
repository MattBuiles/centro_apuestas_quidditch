...
const StandingsPageLocal = () => import('./StandingsPageLocal');
const StandingsPageBackend = () => import('./StandingsPageBackend');

// Export the appropriate component based on configuration
export default FEATURES.USE_BACKEND_LEAGUE_TIME 
  ? React.lazy(() => StandingsPageBackend())
  : React.lazy(() => StandingsPageLocal());
