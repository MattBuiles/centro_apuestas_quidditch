...
// Usar la ruta correcta que apunta a la base de datos del backend
const dbPath = path.join(__dirname, 'backend', 'database', 'quidditch.db');
const db = new sqlite3.Database(dbPath);

console.log('🔍 Simulando partidos en vivo desde la base de datos del backend...\n');
console.log('📂 Usando base de datos:', dbPath);

// Simular los partidos en vivo específicos identificados por el backend
const liveMatchIds = [
  'match-season-2025-6',
  'match-season-2025-7', 
  'match-season-2025-8'
